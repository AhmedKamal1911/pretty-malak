const AR_LANG = {
  ...
  homePage: {
    ...
    aboutUsSection: {
      ...
      aboutDesc:
        "مرحبًا بك في SeaCrow، بوابتك المثالية لاستكشاف عجائب مصر الخالدة. نحن شغوفون بتصميم تجارب سفر لا تُنسى تغمرك بالتاريخ الغني والثقافة النابضة بالحياة والمناظر الطبيعية الخلابة لهذه الأرض القديمة!",
  ...
  aboutUsPage: {
    introText: "من نحن",
    companyInfo: {
      introText: "فريق SeaCrow",
      desc: "مرحبًا بك في SeaCrow، بوابتك المثالية لاستكشاف عجائب مصر الخالدة. نحن شغوفون بتصميم تجارب سفر لا تُنسى تغمرك بالتاريخ الغني والثقافة النابضة بالحياة والمناظر الطبيعية الخلابة لهذه الأرض القديمة.",
    },
    companyStory: {
      introText: "قصتنا",
      desc: "تأسست شركة SeaCrow بحب عميق لمصر ورغبة في مشاركة سحرها مع العالم، وتقدم خدمات سفر استثنائية منذ 19 عامًا. يلتزم فريقنا من خبراء السفر المتفانين والمرشدين المحليين بضمان أن تكون كل رحلة فريدة ومثرية ومصممة خصيصًا لاهتماماتك وتفضيلاتك.",
    },
  ...
  footer: {
    ...
    copyRightReference: "جميع الحقوق محفوظه لدي SeaCrow",
