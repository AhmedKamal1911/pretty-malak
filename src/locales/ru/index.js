const RU_LANG = {
  ...
  homePage: {
    ...
    aboutUsSection: {
      ...
      aboutDesc:
        "Добро пожаловать в SeaCrow, ваш главный шлюз для исследования вечных чудес Египта. Мы увлечены созданием незабываемых путешествий, которые погрузят вас в богатую историю, яркую культуру и захватывающие дух пейзажи этой древней земли!",
  ...
  aboutUsPage: {
    introText: "Кто мы",
    companyInfo: {
      introText: "Команда SeaCrow",
      desc: "Добро пожаловать в SeaCrow, ваш главный шлюз для исследования вечных чудес Египта. Мы увлечены созданием незабываемых путешествий, которые погрузят вас в богатую историю, яркую культуру и захватывающие дух пейзажи этой древней земли.",
    },
    companyStory: {
  ...
  footer: {
    ...
    copyRightReference: "Авторские права защищены SeaCrow",
