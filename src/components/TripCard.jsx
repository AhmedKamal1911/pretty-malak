    ...
    >
      ...
      >
        ...
        <div className="z-50 absolute left-[1em] bottom-[1em] right-[1em] ">
          ...
          <h4 className="absolute bottom-[30px] left-0 right-0 text-white text-2xl sm:text-3xl my-2 line-clamp-2 group-hover:bottom-[80px] transition-all duration-300 delay-[50ms]">
            {title}
          </h4>
